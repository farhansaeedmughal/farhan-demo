...
<!DOCTYPE html> <!--It's tells browser your using HTML5-->
<html lang="en"> <!-- Root of an HTML Document -->
<head> <!-- Container for the Metadata -->
    <meta charset="UTF-8">
...
<Br></Br>
    <!-- using line or horizental ruler -->
     ...
     <!-- Pre text is very important for not missing the spaces and next lines in the  -->
...
<!-- For opening new TAB in the HTML Section -->
